object AddTwoNumbers {
    ...
    private fun doAddTwoNumbers(l1: ListNode?, l2: ListNode?, carry: Boolean): ListNode? {
        if (l1 == null && l2 == null) {
...
fun main(args: Array<String>) {
    ...
    val l2 = ListNode(9).also { it.next = ListNode(9).also { it.next = ListNode(9) } }
    val answer = AddTwoNumbers.addTwoNumbers(l1, l2)
    println(answer)
}
