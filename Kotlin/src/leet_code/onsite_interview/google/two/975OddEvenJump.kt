 ...
 *
 * During our 1st jump (odd numbered), we first jump to i = 1 because A[1] is the smallest value in
 ...
 * (A[2], A[3], A[4]) that is less than or equal to A[1].  A[3] is also the largest value, but 2 is a smaller index,
